     ...
     <div class="col-xs-12 col-sm-12 col-md-5 well well-sm col-md-offset-4"> 
      ...
      <form  action="index.php?action=registration" method="post" class="form" role="form"> 
       <div class="row"> 
        ...
        <div class="col-xs-8 col-md-8"><input class="form-control" name="txttenkh" placeholder="Tên khách hàng"  type="text"> </div> 
        ...
        <div class="col-xs-8 col-md-8"><input class="form-control" name="txtsodt" placeholder="Số điện thoại khách hàng"  type="text"> </div> 
